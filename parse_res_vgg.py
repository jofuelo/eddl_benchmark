...
acc_eddl_tr, acc_eddl_te = get_eddl_res("results/eddl/eddl_vgg16.txt")
...
acc_eddl_tr, acc_eddl_te = get_eddl_res("results/eddl/eddl_vgg16_bn.txt")
...
acc_eddl_tr, acc_eddl_te = get_eddl_res("results/eddl/eddl_vgg19.txt")
...
acc_eddl_tr, acc_eddl_te = get_eddl_res("results/eddl/eddl_vgg19_bn.txt")
