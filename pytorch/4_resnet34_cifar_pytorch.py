...
class ConvNet(nn.Module):
    def __init__(self):
        ...
        self.blocks = nn.Sequential(
            ...
            ResnetBlock(2, 128, 64, 4, bn),
            ResnetBlock(2, 256, 128, 6, bn),
            ResnetBlock(2, 512, 256, 3, bn))
...
if gpu:
    with open("results/pytorch/pytorch_resnet34_"+("batchnorm" if bn else "no_batchnorm"), "wb") as f:
        pickle.dump(acc_list, f)
    with open("results/pytorch/pytorch_val_resnet34_"+("batchnorm" if bn else "no_batchnorm"), "wb") as f:
